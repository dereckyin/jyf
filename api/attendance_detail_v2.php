...
$query = "SELECT  id, username, '' department, '' title, duty_date, TIME_FORMAT(duty_time, '%h:%i %p') duty_time, location, COALESCE(pic_url, '') pic_url, COALESCE(remark, '') remark, COALESCE(`explain`, '') exp, duty_type FROM  on_duty_v2  WHERE duty_date = '" . $date . "' AND  username = '" . $username . "' ORDER BY duty_type, created_at ";
