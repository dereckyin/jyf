      ...
      switch ($method) {
        ...
        case 'POST':
            ...
            /* Bind parameters. Types: s = string, i = integer, d = double,  b = blob */
                $sql = "insert into staff_list_sea (staff, 
                                                phone, 
                                                email, 
                                                address,
                                                punch,
            ...
            case "update":
                    ...
                    /* Bind parameters. Types: s = string, i = integer, d = double,  b = blob */
                    $sql = "update staff_list_sea set staff = ?, 
                                                    phone = ?, 
                                                    email = ?, 
                                                    address = ?, 
                                                    punch = ?, 
              ...
              case 'del':
                $sql = "update staff_list_sea set status = 'D', del_time = now(), del_user = '$user' where id in ($id)";
