...
if($jwt){ 
    ...
    try {
        ...
        // response in json format
            ...
            $sql = "SELECT account, created_at, category, sub_category, project_name, related_account, details, pic_url, payee, paid_date, cash_in, cash_out, remarks from price_record_v2 where is_enabled = true";
            $sql1 = "";
            $sql2 = "";
            $sql3 = "";
