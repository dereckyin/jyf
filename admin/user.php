                    ...
                    <div>
                        <div class="needs-validation form-horizontal" novalidate>
                            ...
                            <ul>
                                ...
                                <li>
                                    <input class="form-check-input" type="checkbox" name="status" required id="A1"
                                           :true-value="1" v-model:checked="gcash_expense_sea_2" @change="updateGCashExpenseSea2"> 啟用海運GCash支出記錄 2
                                </li>
                            </ul>
                            ...
                            <ul>
                                ...
                                <li>
								<input class="form-check-input" type="checkbox" name="report2" required id="A1"
                                           :true-value="1" v-model:checked="report2" @change="update_report2"> 啟用報表2
                                </li>
                            </ul>
                    ...
                    <div>
                        <div class="needs-validation form-horizontal" novalidate>
                            ...
                            <ul>
                                ...
                                <li>
                                    <input class="form-check-input" type="checkbox" id="B1" :true-value="1"  v-model:checked="record.gcash_expense_sea_2" @change="updateEditGCashExpenseSea2" required> 啟用海運GCash支出記錄 2
                                </li>
                            </ul>
                            ...
                            <ul>
                                ...
                                <li>
								<input class="form-check-input" type="checkbox" id="B1" :true-value="1"  v-model:checked="record.report2" @change="update_edit_report2" required> 啟用報表2
                                </li>
                            </ul>
                ...
                <div class="panel-body">
                    <table class="table table-striped table-hover table-sm ">
                        ...
                        <tr v-for='(rec, index) in receive_records'>
                            ...
                            <td>{{ (rec.gcash_expense_sea_2 == '1') ? "是 (yes)" : "否 (no)" }}</td>
