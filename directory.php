...
<head>
    ...
    <style>
        ...
        div.tablebox.d02 > ul > li:nth-of-type(1) {
            width: 86px;
        }

        div.tablebox.d02 > ul > li:nth-of-type(2) {
            min-width: 180px;
            max-width: 180px;
        }

        div.tablebox.d02 > ul > li:nth-of-type(3),
        div.tablebox.d02 > ul > li:nth-of-type(10) {
            min-width: 264px;
            max-width: 264px;
        }

        div.tablebox.d02 > ul > li:nth-of-type(4), div.tablebox.d02 > ul > li:nth-of-type(7) {
            min-width: 230px;
            max-width: 230px;
            padding: 8px 40px 8px 20px;
        }

        div.tablebox.d02 > ul > li:nth-of-type(6), div.tablebox.d02 > ul > li:nth-of-type(9) {
            min-width: 284px;
            max-width: 284px;
            padding: 8px 20px 8px 40px;
        }

        div.tablebox.d02 > ul > li:nth-of-type(5), div.tablebox.d02 > ul > li:nth-of-type(8) {
            min-width: 264px;
            max-width: 264px;
            overflow-x: auto;
            padding: 8px 0;
        ...
        div.tablebox.d02 > ul > li:nth-of-type(11) {
            min-width: 350px;
            max-width: 350px;
        }
                ...
                <div class="tablebox d01">
                    <ul>
                        ...
                        <li>
                            ...
                            <span class="text-danger" v-if="error_supplier"
                                  v-text="error_supplier">{{error_supplier}}</span>
                    </ul>
                    <ul>
                        <li>電話
                            <eng>Phone</eng>
                ...
                <div class="tablebox d01">
                    <ul>
                        ...
                        <li>
                            ...
                            <span class="text-danger" v-if="error_customer"
                                  v-text="error_customer">{{error_customer}}</span>
                    </ul>
                    <ul>
                        <li>電話
                            <eng>Phone</eng>
