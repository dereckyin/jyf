                    ...
                    <template v-for='(row, i) in receive_records'>
                        <tr v-for='(item, j) in row.measure'>
                            ...
                            <td>
                                ...
                                <button @click="edit_item(item)" v-if="item.is_checked == 0">Edit</button>
                                <button @click="save_item(item)" v-if="item.is_checked == 1">Save</button>
                                <button style="margin-left: 10px;" @click="cancel_item(item)" v-if="item.is_checked == 1">Cancel</button>
...
<script type="text/javascript" src="js/edit_soldto_dr.js" defer></script>
