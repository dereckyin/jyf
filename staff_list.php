            ...
            <div class="mainContent" style="padding-top: 70px;">
                ...
                <div class="block" v-else>
                    ...
                    <div class="btnbox">
                        ...
                        <a class="btn" @click="editReceiveRecord($event)" style="color:white;">Save</a> </div>
                    </div>
                    <div class="block record show">
                            ...
                            <div class="listheader">
                                <div class="pageblock" style="float:right;"> Page Size:
                                    ...
                                    <div class="pageblock"><a class="first micons" @click="page=1">first_page</a> <a class="prev micons" :disabled="page == 1" @click="page < 1 ? page = 1 : page--">chevron_left</a>
                                        ...
                                        <a class="next micons" :disabled="page == pages.length" @click="page++">chevron_right</a> <a class="last micons" @click="page=pages.length">last_page</a>
                                    </div>
                                </div>
                        ...
                        <div class="btnbox">
                            ...
                            <a class="btn small" style="color:white;" v-bind:href="pageUrl">Export</a>
                        </div>
                    </div>
                </div>
            </div>
