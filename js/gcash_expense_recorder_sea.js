  ...
  methods: {
    getAllPriceRecord: function() {
      ...
      axios({
        ...
        url: "api/add_or_edit_gcash_expense_recorder_sea.php",
        data: form_Data,
      })
    ...
    printRecord: function() {
      ...
      axios({
        method: "post",
        url: "api/gcash_expense_record_print_sea.php",
        data: form_Data,
        responseType: "blob",
      })
        .then(function(response) {
    ...
    getRecords: function() {
      ...
      axios
        .get("api/add_or_edit_gcash_expense_recorder_sea.php", {
          params,
    ...
    upload: function() {
      ...
      myArr.forEach((element, index) => {
        ...
        myForm.append("batch_type", "gcash");
        myForm.append("batch_id", 0);
        myForm.append("today", vm.file_day);

        axios
          .post("api/upload_price_record_gcp.php", myForm, config)
          .then(function(res) {
            if (res.data.code == 0) {
