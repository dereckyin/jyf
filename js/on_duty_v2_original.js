    ...
    onChangeFileUpload() {
          const _this = this;
            this.file = document.getElementById('file').files[0];
                  ...
                  EXIF.getData(document.getElementById('file').files[0], function() {
        ...
        validateForm() {
            ...
            file = this.$refs.file.files[0]
              ...
              if(this.type == '' || this.name == '' || this.today == '' || file == undefined) {
      ...
      upload: function() {
        ...
        //   }
          ...
          axios({
                  ...
                  url: 'api/on_duty_v2_original.php',
                  data: form_Data
              })
              .then(function(response) {
                  //handle success
