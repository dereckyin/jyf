            ...
            success: function(json) {
              // Add response in Modal body
                ...
                for (var i = 0; i < contentJson.length; i++) {
                    ...
                    html += "<tr onclick='data1(this)'><td>" + customer + "</td><td>" + c_phone + "</td><td>" + c_fax + "</td><td>" + c_email + "</td></tr>";
            ...
            success: function(json) {
              // Add response in Modal body
                ...
                for (var i = 0; i < contentJson.length; i++) {
                    ...
                    html += "<tr onclick='data(this)'><td>" + shipping_mark + "</td><td>" + customer + "</td><td>" + c_phone + "</td><td>" + c_fax + "</td><td>" + c_email + "</td></tr>";
                    //$("#contact").append("<tr onclick='data(this)'><td>" + customer + "</td><td>" + c_phone + "</td><td>" + c_fax + "</td><td>" + c_email + "</td></tr>");
                }
